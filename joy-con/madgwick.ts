...
export type EulerAngles = {
  /**The direction of the object.  Angle around Z-axis.*/
  heading: number
  /**The forward/backward attitude of the object.  Angle around Y-axis.*/
  pitch: number
  /**The sideways angle of the object.  Angle around X-axis.*/
  roll: number
}
...
export function Madgwick(
  ...
  options?: { beta?: number; doInitialisation?: boolean },
) {
  //---------------------------------------------------------------------------------------------------
  // Definitions
  ...
  let initialized = options.doInitialisation === true ? false : true
  ...
  function madgwickAHRSUpdateIMU(
    ...
    if (!(ax === 0.0 && ay === 0.0 && az === 0.0)) {
      ...
      recipNorm = (s0 * s0 + s1 * s1 + s2 * s2 + s3 * s3) ** -0.5 // normalize step magnitude
      s0 *= recipNorm
      s1 *= recipNorm
      s2 *= recipNorm
      s3 *= recipNorm
  ...
  function eulerAnglesFromImuRad(
    ...
    ay: number,
    az: number,
    // Todo: this may not be a correct default
    mx: number = 0,
    my: number = 0,
    mz: number = 0,
  ): EulerAngles {
  ...
  function toQuaternion(eulerAngles: EulerAngles): Point4 {
  ...
  /**
   * Initialize the internal quaternion values.  This function only needs to be
